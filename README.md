...
to write server code, specifically web services that can communicate with clients using the JSON (JavaScript Object Notation) format for data interchange.
